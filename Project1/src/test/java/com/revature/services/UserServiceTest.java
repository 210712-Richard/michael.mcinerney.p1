...
public class UserServiceTest {
	...
	public void testLoginValid() {
		//Set up mockito so that when dao.getUser is called, it will return the user as it should.
		...
		assertEquals(user.getUsername(), usernameCaptor.getValue(), "Assert that the username used is the user's username.");
		assertEquals(user.getPassword(), passwordCaptor.getValue(), "Assert that the password used is the user's password.");
	}
